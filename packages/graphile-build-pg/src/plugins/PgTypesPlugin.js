...
import type { BuildExtension as PgIntrospectionPluginBuildExtension } from "./PgIntrospectionPlugin";
export type BuildExtension = {|
  pgRegisterGqlTypeByTypeId: () => void,
  pgRegisterGqlInputTypeByTypeId: () => void,
  pgGetGqlTypeByTypeId: () => GraphQLNamedType,
  pgGetGqlInputTypeByTypeId: () => GraphQLNamedType,
  pg2GqlMapper: { [typeId: string]: mixed },
  pg2gql: () => mixed,
  gql2pg: () => mixed,
  pgTweakFragmentForType: () => mixed,
  pgTweaksByTypeId: () => mixed,
|};
...
export default (function PgTypesPlugin(
  ...
  builder.hook(
    ...
    (build: {
      ...Build,
      ...PgIntrospectionPluginBuildExtension,
    }): {
      ...Build,
      ...PgIntrospectionPluginBuildExtension,
      ...BuildExtension,
      ...
      */
      ...
      const pgTypeById = introspectionResultsByKind.type.reduce(
        (memo, type) => {
          memo[type.id] = type;
          return memo;
        },
